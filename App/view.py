...
def print_req_3(info_req3, mode = 0):
    """
        Función que imprime la solución del Requerimiento 3 en consola
    """
    # TODO: Imprimir el resultado del requerimiento 3
    distancia_total = 0
    print("El aeropuerto de mayor importancia segun la concurrencia comercial es:")
    
    table = []
    header = ['ICAO','Nombre','Ciudad','Pais', 'Concurrencia Comercial']
    header1 = ['A->B',
    ...
    table.append(header)
    table.append([me.getValue(mp.get(control['model']['Aeropuerto_COM'],info_req3[0]))['ICAO'],
                  me.getValue(mp.get(control['model']['Aeropuerto_COM'],info_req3[0]))['Nombre'],
                  me.getValue(mp.get(control['model']['Aeropuerto_COM'],info_req3[0]))['Ciudad'],
                  me.getValue(mp.get(control['model']['Aeropuerto_COM'],info_req3[0]))['Pais'],
                  me.getValue(mp.get(control['model']['Aeropuerto_COM'],info_req3[0]))['Cantidad']])
    print(tabulate(table))
    ...
    print("El numero total de trayectos:", lt.size(info_req3[2]))
    print("La distancia total de los trayectos: ", distancia_total)
    j = 1
    if (mode == 1):   
        
        for camino in lt.iterator(info_req3[6]):
            i = 1
            table1 = []
        ...
        for camino in lt.iterator(info_req3[2]):
            table1 = []
            table1.append(header1)
            ...
            distancia_tot = 0
            naves = []
            for distancia in lt.iterator(lt.getElement(info_req3[5],j)): distancia_tot += float(distancia)
            ...
            table1.append([(origen,"->",destino),
                            ...
                            distancia_tot,
                            lt.getElement(info_req3[5],j),
                            naves])
            print(tabulate(table1))
            j += 1


def print_req_4(info_req4, mode = 0):
    """
        Función que imprime la solución del Requerimiento 3 en consola
    """
    # TODO: Imprimir el resultado del requerimiento 3
...
def print_req_6(control):
    ...
    m=input("Ingrese la cantidad de aeropuertos más importantes en Colombia que se desea cubrir: ")
